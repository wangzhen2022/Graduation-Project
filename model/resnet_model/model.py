...
class ResNet18(nn.Module):
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(RestNetDownBlock(64, 128, 1),
                                    RestNetBasicBlock(128, 128, 1))

        self.layer3 = nn.Sequential(RestNetDownBlock(128, 256, 1),
                                    RestNetBasicBlock(256, 256, 1))

        self.layer4 = nn.Sequential(RestNetDownBlock(256, 512,  1),
